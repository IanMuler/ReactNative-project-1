import { operations, components } from "../../generated_types/types";

export enum Storage {
  FAVORITES = "favorites",
}

export type PokemonFull = components["schemas"]["PokemonFull"];
export type PokemonPaginatedResponse =
  components["schemas"]["PokemonPaginatedResponse"];

export type PokemonListQuery =
  operations["getPokemonList"]["parameters"]["query"];
